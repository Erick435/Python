...
class User:
    ...
    def validate_user(data):
        ...
        if len(data['username']) < 3 or len(data['username']) > 20:
            is_valid = False
            flash("Username must be at least 3 characters, upt to 20 character")
        ...
        if len(User.get_user_by_email(data)) != 0: #THIS COULD BE THE SAME
                                                #FOR THE USERNAME IF STATEMENT
            is_valid = False
